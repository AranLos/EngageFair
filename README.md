...
Then BaselinesGridSearch1.ipynb. This produces the baseline models.
Then FairModel1.ipynb. This produces the fair model.
Afterward, the other notebooks can be run with the produced files and information from the previously mentioned notebooks.
